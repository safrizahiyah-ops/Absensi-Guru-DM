...
export const MasterTeachersView: React.FC = () => {
  const { teachers, subjects, settings, addTeacher, updateTeacher, deleteTeacher, showToast } = useAttendance();
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 font-bold text-xs shadow-xs transition-colors"
          >
